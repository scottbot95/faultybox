{ fetchurl, fetchgit, linkFarm, runCommand, gnutar }: rec {
  ...
  packages = [
    {
      name = "https___registry.npmjs.org__patternfly_patternfly___patternfly_4.222.4.tgz";
      path = fetchurl {
        name = "https___registry.npmjs.org__patternfly_patternfly___patternfly_4.222.4.tgz";
        url  = "https://registry.npmjs.org/@patternfly/patternfly/-/patternfly-4.222.4.tgz";
        sha512 = "+0fk4dzxEbWn+hgaOnR0BjfeUdEeVVrqfH7+GFeFc+RKjEMjIR/BZbWWN8YQDezmDv6A32gHmEKaY3Uwbt06Lw==";
      };
    }
    {
    ...
    {
      name = "https___registry.npmjs.org_immutable___immutable_4.2.1.tgz";
      path = fetchurl {
        name = "https___registry.npmjs.org_immutable___immutable_4.2.1.tgz";
        url  = "https://registry.npmjs.org/immutable/-/immutable-4.2.1.tgz";
        sha512 = "7WYV7Q5BTs0nlQm7tl92rDYYoyELLKHoDMBKhrxEoiV4mrfVdRz8hzPiYOzH7yWjzoVEamxRuAqhxL2PLRwZYQ==";
      };
    }
    {
    ...
    {
      name = "https___registry.npmjs.org_sass___sass_1.57.1.tgz";
      path = fetchurl {
        name = "https___registry.npmjs.org_sass___sass_1.57.1.tgz";
